...
public class GitCommandHandler {
	 ...
	 */
	public void cloneRepository(String uri, String name, String password, String id) throws IOException, InvalidRemoteException, TransportException, GitAPIException {
		localPath = File.createTempFile(id, "");
		localPath.delete();
		
		repo = Git.cloneRepository().setURI(uri).setCredentialsProvider(new UsernamePasswordCredentialsProvider(name, password)).setDirectory(localPath).call();
	 ...
	 * @throws GitAPIException
	 */
	public void createBranch(String branchName) throws IOException, RefAlreadyExistsException, RefNotFoundException, InvalidRefNameException, CheckoutConflictException, GitAPIException {
	 ...
	 * @throws GitAPIException
	 */
	public void checkoutBranch(String branchName) throws RefAlreadyExistsException, RefNotFoundException, InvalidRefNameException, CheckoutConflictException, GitAPIException {
